...
export type DeleteToDoByIdMutation = {
  __typename?: 'Mutation';
  deleteToDoById?: boolean | null;
};
...
`;
export type DeleteToDoByIdMutationFn = Apollo.MutationFunction<
  DeleteToDoByIdMutation,
  DeleteToDoByIdMutationVariables
>;
 ...
 * });
 */
export function useDeleteToDoByIdMutation(
  ...
  return Apollo.useMutation<
    DeleteToDoByIdMutation,
    DeleteToDoByIdMutationVariables
  >(DeleteToDoByIdDocument, options);
}
export type DeleteToDoByIdMutationHookResult = ReturnType<
  typeof useDeleteToDoByIdMutation
>;
export type DeleteToDoByIdMutationResult =
  Apollo.MutationResult<DeleteToDoByIdMutation>;
export type DeleteToDoByIdMutationOptions = Apollo.BaseMutationOptions<
  DeleteToDoByIdMutation,
  DeleteToDoByIdMutationVariables
>;
